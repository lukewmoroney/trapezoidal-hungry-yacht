...
const sent1 = [
  "The cat comes back",
  "The cat is black",
  "The cat is barking at the door",
  "What cat?",
  "What, cat?",
  "What? Cat.",
  "Cat is everything.",
...
const fiveSyllables = [
  ...
  "to become something",
  "and doing our best",
  "til everything leaves",
  "to breathe after death",
];
const sevenSyllables = [
  "as the birds are as the worms",
  "going up in the sunlight",
  "beginning and beginning",
  "who knows at night what happens?",
  "our limbs hang lower today",
];
